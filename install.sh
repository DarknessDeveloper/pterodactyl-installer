...
export GITHUB_BASE_URL="https://raw.githubusercontent.com/DarknessDeveloper/pterodactyl-installer"
...
rm -rf /tmp/lib.sh
curl -sSL -o /tmp/lib.sh "https://raw.githubusercontent.com/DarknessDeveloper/pterodactyl-installer/master/lib/lib.sh"
